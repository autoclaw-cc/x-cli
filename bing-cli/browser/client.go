...
// Status reports whether the kimi-webbridge daemon and its Chrome extension
// are alive. Always call this before Navigate/Evaluate so the user gets a
// clear diagnostic when the bridge is down.
type Status struct {
